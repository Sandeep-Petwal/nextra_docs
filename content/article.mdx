...
Ready to build your documentation site? Start with the [Nextra Docs Starter](https://github.com/Sandeep-Petwal/nextra_docs) template to skip the setup and jump straight into writing content.
