...
- **Issues**: [GitHub Issues](https://github.com/Sandeep-Petwal/nextra_docs/issues)
- **Discussions**: [GitHub Discussions](https://github.com/Sandeep-Petwal/nextra_docs/discussions)
- **Nextra Docs**: [Official Documentation](https://nextra.site)

## Show Your Support

If this template helped you, consider:
- ⭐ [Starring the repository](https://github.com/Sandeep-Petwal/nextra_docs)
- 🐛 [Reporting issues](https://github.com/Sandeep-Petwal/nextra_docs/issues)
- 💡 [Suggesting features](https://github.com/Sandeep-Petwal/nextra_docs/discussions)
- 📖 [Contributing improvements](https://github.com/Sandeep-Petwal/nextra_docs/pulls)
